...
const GetStarted = () => {
  return (
    <section className="h-screen bg-gray-700 font-Montserrat text-white">
      <section id="navigation" className="h-screen bg-gray-700 text-white">
        <nav className="flex justify-between px-8 py-8">
          <div>
            <h1>
              <NavLink to="/" className="p-5 text-3xl font-semibold">
                Champion Quiz
              </NavLink>
            </h1>
          </div>
        ...
        <main className="px-16 py-16">
          ...
          <NavLink to="/home-page" className="">
            <div className="flex items-center justify-center pt-20">
              <div className="btn btn:hover relative h-40 w-40 rounded-full bg-green-500"></div>
